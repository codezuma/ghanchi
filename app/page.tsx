  ...
  return (
    <div className="containerMod">
      <div className="containerMod p-4 mt-9">
        ...
        <img className="" src="/homebanerimg.png" />
        <h1 className=" mt-5 text-center text-2xl font-semibold tracking-wider"> Welcome to </h1>
        <h1 className=" mb-7 text-center text-red-800 font-semibold text-2xl tracking-wider"> RAJSURI PRINT & PACK </h1>
        <div className="w-[450px]">
          <AspectRatio className='border' ratio={16 / 9}>
            youtube video
          </AspectRatio>
        </div>
        <div className="text-justify font-medium tracking-tight mt-7 max-w-[70%]">
        ...
        <div className="mt-5 grid px-2 grid-cols-2 gap-x-2 gap-y-2 rounded-md w-full md:grid-cols-3">
          ...
          <div className="flex flex-col justify-start items-center">
            ...
            <p className="font-medium text-center mt-2">Modern & Latest Design</p>
          </div>
          ...
          <div className="flex flex-col justify-start items-center">
            ...
            <p className="font-medium text-center mt-2">Clients & Network</p>
          </div>
          <div className="flex flex-col justify-start items-center">
            <div className="bg-rose-500 rounded-md p-2 grid size-36">
              <img src="/coin-in-hand.png" className="h-20 w-20 place-self-center" alt="" />
            </div>
            <p className="font-medium text-center mt-2">Most Affordable Prices/Rates</p>
          </div>
          ...
          <div className="flex flex-col justify-start items-center">
            ...
            <p className="font-medium text-center mt-2">Best Quality Printing</p>
          </div>
          <div className="flex flex-col justify-start items-center">
            <div className="bg-rose-500 rounded-md p-2 grid size-36">
              <img src="/Popularman.svg" className="h-20 w-20 place-self-center" alt="" />
            </div>
            <p className="font-medium text-center mt-2">Highly Experienced Staff</p>
          </div>
      ...
      <div className="mt-2 grid grid-cols-1 px-5 gap-2 w-[100%] lg:grid-cols-2">
        <div className=" mt-3 w-full flex flex-col align-middle items-center">
          <div className="flex w-56 align-middle justify-center">
      ...
      <div className="bg-rose-500  w-[100%] mt-20 flex flex-col justify-start items-center">
        ...
        <h3 className="mt-1 text-center text-slate-50 max-w-96">
