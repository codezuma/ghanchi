...
const Footer = () => {
  return (
    <div className='w-full  bg-sky-950 p-10 flex flex-col justify-center'>
      <h1 className='text-3xl text-slate-50 mb-6'>CONTACT US:</h1>

      <h2 className='text-slate-50 ml-5 text-xl'>rajsuriprintandpack@gmail.com</h2>
      <h2 className='text-slate-50 ml-5 text-xl font-medium'>9636941272</h2>
      <h2 className='text-slate-50 ml-5 text-xl font-medium'>9636941272</h2>
      <h2 className='text-slate-50 mt-4 ml-3 text-2xl'>
